...
// Chennai Coordinates for Real Maps
...
export const sellers = [
  { 
    ...
    status: 'ONLINE',
    inventory: { choc_cone: 24, mango_cup: 1, vanilla_bar: 8, strawberry_bar: 15 },
    spoiled: { choc_cone: 0, mango_cup: 2, vanilla_bar: 0, strawberry_bar: 0 },
    lastFridgeUpdate: '13.078, 80.265'
  },
  { 
    id: 'seller_2', 
    name: 'Saravana', 
    location: [13.0405, 80.2337], // T-Nagar area
    status: 'ONLINE',
    ...
    lastFridgeUpdate: '13.042, 80.235'
  },
  { 
    id: 'seller_3', 
    name: 'Vijay', 
    location: [12.9171, 80.2281], // OMR/Thoraipakkam
    status: 'OFFLINE',
    inventory: { choc_cone: 0, mango_cup: 0, vanilla_bar: 0, strawberry_bar: 0 },
    spoiled: { choc_cone: 0, mango_cup: 0, vanilla_bar: 0, strawberry_bar: 0 },
    lastFridgeUpdate: '12.915, 80.225'
  }
];

// Heatmap Data (Simulated demand in Chennai)
export const demandHeatmap = [
  [13.0827, 80.2707, 0.8], // Central
  [13.0405, 80.2337, 0.9], // T-Nagar
  [12.9171, 80.2281, 0.5], // OMR
  [13.0067, 80.2206, 0.7], // Adyar
  [13.1133, 80.2444, 0.4]  // Anna Nagar
];
